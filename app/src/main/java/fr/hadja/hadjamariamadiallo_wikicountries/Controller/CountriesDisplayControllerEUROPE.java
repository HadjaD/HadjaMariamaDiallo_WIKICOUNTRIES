...
public class CountriesDisplayControllerEUROPE implements Callback<List<Country>> {
    private EuropeanCountriesActivity view;
    private SharedPreferences sharedPreferences;
    private Continent continent;
    private Continent cont = null;
    String BASE_URL = "https://restcountries.eu/rest/v2/region/";

    public CountriesDisplayControllerEUROPE(EuropeanCountriesActivity view,
    ...
    public void start() {
        ...
        Call<List<Country>> call = countryApi.getEuropeanCountries("status:open");
        call.enqueue(this);
