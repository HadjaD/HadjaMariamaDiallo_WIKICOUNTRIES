...
public class CountriesDisplayControllerAFRICA implements Callback<List<Country>> {
    private AfricanCountriesActivity view;
    private SharedPreferences sharedPreferences;
    private Continent continent;
    private Continent cont = null;
    String BASE_URL = "https://restcountries.eu/rest/v2/region/";

    public CountriesDisplayControllerAFRICA(AfricanCountriesActivity view,
